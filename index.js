...
const UUID = process.env.UUID || 'ecb5d57a-b171-40e4-a6d6-9f402b6b042b'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.520961.xyz:8008';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'rUYLjmYX54qvUp8vc06JQTGaJcSwzPh7';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
